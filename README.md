...
一、平台分為一般閱聽者、學習分享者、資訊管理群三層。各有不同權限。

1. 一般閱聽者：平台採Google登入制，與[自學2.0](https://we.alearn.org.tw)相同，註冊即可免費登入。並可選擇興趣主題，以方便未來相關主題的分享推播。閱聽者享有對相關學習步驟文案的發問、讚美等回饋權利。

2. 學習分享著：需以符合平台的格式，具體記載某項學習的步驟，經資訊管理群確認後，即可發表。（學習步驟可連結相關網路資訊或個人網站。）

3. 資訊管理群：負責對待發文案的形式審查（非實質內容審查。管理群僅對文案書寫格式、其所連結的外部資訊是否涉及色情、暴力等非法內容等做審查。凡獲得資訊管理成員3/4以上之參與，參與者3/4以上之同意者，即可發表）

二、用戶在本平台發佈之內容，均需採CC-BY-SA授權開源模式，或更寬之授權。也就是說，和目前[自由數學](https://math.alearn.org.tw)相同。
...
<img src="https://github.com/bestian/colearna-open/assets/109048/a3158ba8-b1c8-4a35-94c2-2b1a739b7af7" width=500  alt="社會變革" />
