import{_ as y,C as I,r as N,c as C,h as g,v as D,e as O,F as _}from"./index.esm.5c1ec681.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const G="auth-internal",H="app-check-internal",J="messaging-internal";function V(e,t){const n=(r,{instanceIdentifier:i})=>{const o=r.getProvider("app").getImmediate(),s=r.getProvider(G),c=r.getProvider(J),l=r.getProvider(H);return new R(o,s,c,l,i,e)};y(new I(m,n,"PUBLIC").setMultipleInstances(!0)),N(A,k,t),N(A,k,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function j(e=O(),t=p){const r=C(g(e),m).getImmediate({identifier:t}),i=D("functions");return i&&B(r,...i),r}function B(e,t,n){U(g(e),t,n)}function K(e,t,n){return x(g(e),t,n)}V(fetch.bind(self));export{j as g,K as h};
